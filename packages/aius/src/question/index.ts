...
export const Option = Schema.Struct({
  ...
  recommended: Schema.optional(Schema.Boolean).annotate({
    description: "Mark the safe default. Every question must have exactly one; it is preselected so the user can just confirm.",
  }),
...
export const Info = Schema.Struct({
  ...
  // System-set (not exposed on the LLM `question` tool, which uses Prompt):
  // render a red, high-attention confirmation for heavy or irreversible work
  // (e.g. a multi-hour run). The safe option stays the default.
  danger: Schema.optional(Schema.Boolean).annotate({
    description: "Render as a red heavy-work confirmation; the safe option stays the default.",
  }),
...
export class Service extends Context.Service<Service, Interface>()("@aius/Question") {}
