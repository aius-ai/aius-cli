import type * as SDK from "@aius-ai/sdk/v2"
...
const disabled = process.env["AIUS_DISABLE_SHARE"] === "true" || process.env["AIUS_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@aius/ShareNext") {}
