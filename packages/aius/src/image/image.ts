...
export class Service extends Context.Service<Service, Interface>()("@aius/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __AIUS_PHOTON_WASM_PATH?: string }).__AIUS_PHOTON_WASM_PATH =
