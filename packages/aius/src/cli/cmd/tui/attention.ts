...
} from "@aius-ai/plugin/tui"
import stripAnsi from "strip-ansi"
import type { TuiConfig } from "./config/tui"
import { isAttentionSoundName } from "./config/tui-schema"
import * as TuiAudio from "@tui/util/audio"
import defaultSoundPath from "./sounds/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "./sounds/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "./sounds/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "./sounds/nope-03.mp3" with { type: "file" }
import doneSoundPath from "./sounds/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "./sounds/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "aius"
const DEFAULT_PACK_ID = "aius.default"
