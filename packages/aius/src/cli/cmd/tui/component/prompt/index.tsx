...
import type { AssistantMessage, FilePart, UserMessage } from "@aius-ai/sdk/v2"
...
import { AIUS_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useAiusKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.AIUS_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
