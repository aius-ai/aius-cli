  ...
  init: () => {
    ...
    const model = iife(() => {
      ...
      const fallbackModel = createMemo(() => {
        ...
        // Skip modelStore.recent on purpose: in Aius the model is product-owned,
        // not user-managed. We honour CLI --model and aius.jsonc#model above,
        // but everything else falls through to the provider default (claude-opus-4-7
        // via the priority sort) regardless of what the user picked previously.
