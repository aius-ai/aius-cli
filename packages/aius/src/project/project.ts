...
import { AppProcess } from "@aius-ai/core/process"
import { Project as ProjectV2 } from "@aius-ai/core/project"
import { CrossSpawnSpawner } from "@aius-ai/core/cross-spawn-spawner"
import { AbsolutePath, NonNegativeInt, optionalOmitUndefined } from "@aius-ai/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@aius/Project") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(ProjectVcs))(Flag.AIUS_FAKE_VCS)
      ...
      Effect.fn("Project.initState")(function* (ctx) {
        yield* (yield* bus.subscribe(Command.Event.Executed)).pipe(
          Stream.runForEach((payload) =>
            payload.properties.name === "init" ? setInitialized(ctx.project.id) : Effect.void,
          ),
          Effect.forkScoped,
        )
      }),
