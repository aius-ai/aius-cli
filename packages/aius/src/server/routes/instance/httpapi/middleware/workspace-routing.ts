...
>()("@aius/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@aius/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceID | undefined {
  return Flag.AIUS_WORKSPACE_ID ? WorkspaceID.make(Flag.AIUS_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-aius-directory"] || process.cwd()
}
