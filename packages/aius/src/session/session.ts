import { Slug } from "@aius-ai/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@aius-ai/llm"
...
import { NonNegativeInt, optionalOmitUndefined } from "@aius-ai/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".aius", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@aius/Session") {}
