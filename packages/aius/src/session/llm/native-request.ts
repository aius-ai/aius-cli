import type { JsonSchema, LLMRequest, ProviderMetadata } from "@aius-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@aius-ai/llm"
import { OpenRouter } from "@aius-ai/llm/providers"
...
export const request = (input: RequestInput) => {
  ...
  // @aius-ai/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
