 ...
 *   "@aius/ServerAuthConfig",
 *   {
 *     password: Config.string("AIUS_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("AIUS_SERVER_USERNAME").pipe(Config.withDefault("opencode")),
 *   },
 * ) {}
 *
