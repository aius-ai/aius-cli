...
import { sanitizedProcessEnv } from "@aius-ai/core/util/aius-process"
...
export class Service extends Context.Service<Service, Interface>()("@aius/Ripgrep") {}
    ...
    Effect.gen(function* () {
      ...
      const tree: Interface["tree"] = Effect.fn("Ripgrep.tree")(function* (input: TreeInput) {
        ...
        for (const file of list) {
          if (file.includes(".aius")) continue
