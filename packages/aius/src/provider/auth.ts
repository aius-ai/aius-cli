import type { AuthOAuthResult, Hooks } from "@aius-ai/plugin"
...
const OpenRouterMethods = Schema.decodeUnknownSync(Methods)({
  openrouter: [
    {
      type: "api",
      label: "AIUS API key",
...
export class Service extends Context.Service<Service, Interface>()("@aius/ProviderAuth") {}
...
export const layer: Layer.Layer<Service, never, Auth.Service | Plugin.Service> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const methods = Effect.fn("ProviderAuth.methods")(function* () {
      ...
      const pluginMethods = Record.map(hooks, (item) =>
      ...
      return decode(
        hooks[ProviderID.openrouter] ? pluginMethods : { ...pluginMethods, openrouter: OpenRouterMethods.openrouter },
      )
    })
