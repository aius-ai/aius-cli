...
export class Service extends Context.Service<Service, Interface>()("@aius/Workspace") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        AIUS_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        AIUS_WORKSPACE_ID: config.id,
        AIUS_EXPERIMENTAL_WORKSPACES: "true",
