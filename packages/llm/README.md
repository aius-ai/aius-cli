...
Schema-first LLM core for Aius. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@aius-ai/llm"
import { OpenAI } from "@aius-ai/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@aius-ai/llm/providers"
