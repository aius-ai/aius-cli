...
export type OpenAIChatMessage = Schema.Schema.Type<typeof OpenAIChatMessage>
...
export const fromRequest = Effect.fn("OpenAIChat.fromRequest")(function* (request: LLMRequest) {
