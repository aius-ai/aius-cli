...
import { ensureProcessMetadata } from "../util/aius-process"
...
export function resource(): { serviceName: string; serviceVersion: string; attributes: Record<string, string> } {
  ...
  return {
    ...
    attributes: {
      ...
      "aius.client": Flag.AIUS_CLIENT,
      "aius.process_role": processMetadata.processRole,
      "aius.run_id": processMetadata.runID,
