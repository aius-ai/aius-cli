...
// test/preload.ts pins AIUS_MODELS_PATH to a fixture so other tests can
...
// bun process.
const ORIGINAL_MODELS_PATH = Flag.AIUS_MODELS_PATH
const ORIGINAL_DISABLE_FETCH = Flag.AIUS_DISABLE_MODELS_FETCH
beforeAll(() => {
  Flag.AIUS_MODELS_PATH = undefined
  Flag.AIUS_DISABLE_MODELS_FETCH = true
})
afterAll(() => {
  Flag.AIUS_MODELS_PATH = ORIGINAL_MODELS_PATH
  Flag.AIUS_DISABLE_MODELS_FETCH = ORIGINAL_DISABLE_FETCH
})
